...
>
	<div>
		...
		<h3 class="align-top font-serif text-2xl font-normal text-white">Scale, Process, Govern</h3>
	</div>
	<div class="flex w-40 justify-center">
		<a href={resolve('/home')} class="w-32 rounded-md bg-white p-2 text-center font-mono text-black"
			>Dive</a
		>
	</div>
</div>
